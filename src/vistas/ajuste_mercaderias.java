...
import Dao.detalle_ajuste_mercaderiaDAO;
 ...
 *
 */
public class ajuste_mercaderias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        detalle_ajuste.setTitle(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.detalle_ajuste.title")); // NOI18N
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel12.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel1.text")); // NOI18N
        jLabel1.setName("jLabel1"); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel2.text")); // NOI18N
        ...
        agregar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.agregar.text")); // NOI18N
        ...
        editar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.editar.text")); // NOI18N
        ...
        eliminar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.eliminar.text")); // NOI18N
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jPanel9.border.title"))); // NOI18N
        ...
        grabar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.grabar.text")); // NOI18N
        grabar.setToolTipText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.grabar.toolTipText")); // NOI18N
        ...
        Salir.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Salir.text")); // NOI18N
        Salir.setToolTipText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Salir.toolTipText")); // NOI18N
        ...
        jPanel11.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jPanel11.border.title"))); // NOI18N
        ...
        jTBuscarSucursal.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.jTBuscarClientes.text")); // NOI18N
        ...
        AceptarSuc.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.Aceptarcliente.text")); // NOI18N
        ...
        SalirSuc.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.SalirCliente.text")); // NOI18N
        ...
        jTBuscarCliente.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.jTBuscarClientes.text_2")); // NOI18N
        ...
        AceptarCli.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.Aceptarcliente.text_2")); // NOI18N
        ...
        SalirCli.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.SalirCliente.text_2")); // NOI18N
        ...
        jTBuscarGiraduria.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.jTBuscarClientes.text_1")); // NOI18N
        ...
        AceptarGir.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.Aceptarcliente.text_1")); // NOI18N
        ...
        SalirGir.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ventas.SalirCliente.text_1")); // NOI18N
        ...
        item_entrada.setTitle(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.item_entrada.title")); // NOI18N
        ...
        codprod.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.codprod.text")); // NOI18N
        ...
        jLabel25.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.jLabel14.text")); // NOI18N
        jLabel25.setName("jLabel25"); // NOI18N

        BuscarProducto.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.BuscarProducto.text")); // NOI18N
        ...
        nombreproducto.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.nombreproducto.text")); // NOI18N
        nombreproducto.setEnabled(false);
        nombreproducto.setName("nombreproducto"); // NOI18N

        jLabel26.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.jLabel15.text")); // NOI18N
        ...
        cantidad.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.codprod.text")); // NOI18N
        ...
        costo.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.codprod.text")); // NOI18N
        ...
        jLabel28.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.jLabel17.text")); // NOI18N
        ...
        totalitem.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.codprod.text")); // NOI18N
        totalitem.setEnabled(false);
        totalitem.setName("totalitem"); // NOI18N

        cModo.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.codprod.text")); // NOI18N
        cModo.setName("cModo"); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel4.text")); // NOI18N
        jLabel4.setName("jLabel4"); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel5.text")); // NOI18N
        ...
        Guardar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.NuevoItem.text")); // NOI18N
        ...
        SalirItem.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "detalle_facturas.SalirItem.text")); // NOI18N
        ...
        item_entradaLayout.setHorizontalGroup(
            ...
            .addGroup(item_entradaLayout.createSequentialGroup()
                .addGroup(item_entradaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        setTitle(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.title")); // NOI18N
        ...
        jLabel6.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel6.text")); // NOI18N
        ...
        Modificar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Modificar.text")); // NOI18N
        ...
        Eliminar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Eliminar.text")); // NOI18N
        Eliminar.setToolTipText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Eliminar.toolTipText")); // NOI18N
        ...
        Listar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Listar.text")); // NOI18N
        Listar.setToolTipText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.Listar.toolTipText")); // NOI18N
        ...
        refrescar.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.refrescar.text")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel3.text")); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N

        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText(org.openide.util.NbBundle.getMessage(ajuste_mercaderias.class, "ajuste_mercaderias.jLabel7.text")); // NOI18N
    ...
    private void ModificarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (Config.nNivelUsuario < 3) {
            ...
            ajuste_mercaderiaDAO veDAO = new ajuste_mercaderiaDAO();
            ajuste_mercaderia ve = null;
            try {
            ...
            if (ve != null) {
                ...
                detalle_ajuste_mercaderiaDAO detDAO = new detalle_ajuste_mercaderiaDAO();
                try {
                    for (detalle_ajuste_mercaderia detvta : detDAO.MostrarDetalle(creferencia.getText())) {
                ...
                detalle_ajuste.setSize(1058, 680);
                //Establecemos un título para el jDialog
                detalle_ajuste.setTitle("Modificar Ingreso de Mercaderías");
                detalle_ajuste.setLocationRelativeTo(null);
                detalle_ajuste.setVisible(true);
                sucursal.requestFocus();
            } else {
    ...
    private void EliminarActionPerformed(ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (Config.nNivelUsuario==1) {
            ...
            if (ret == 0) {
                ...
                detalle_ajuste_mercaderiaDAO detDAO = new detalle_ajuste_mercaderiaDAO();
                ajuste_mercaderiaDAO cabDAO = new ajuste_mercaderiaDAO();
                try {
                    if (num == null) {
                        JOptionPane.showMessageDialog(null, "Registro no Existe");
                    } else {
                        detDAO.borrarDetalleEntrada(num);
        ...
        if (Double.valueOf(cTotal) > 0) {
            ...
            if (ret == 0) {
                ...
                if (Integer.valueOf(this.numero.getText()) == 0) {
                    ...
                    detalle_ajuste_mercaderiaDAO detDAO = new detalle_ajuste_mercaderiaDAO();
                    try {
                        detDAO.borrarDetalleEntrada(referencia);
...
//this.cantidad.requestFocus();       
    ...
    private class GenerarReporte extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                URL url = getClass().getClassLoader().getResource("Reports/ticket_entradas.jasper");
    ...
    private class GrillaMercaderia extends Thread {
        ...
        public void run() {
            ...
            ajuste_mercaderiaDAO DAO = new ajuste_mercaderiaDAO();
            try {
                for (ajuste_mercaderia ajuste : DAO.MostrarxFecha(dFechaInicio, dFechaFinal)) {
